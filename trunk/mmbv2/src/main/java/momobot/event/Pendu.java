...
public class Pendu extends AbstractChannelEvent {
    ...
    public final StrBuilder submitLettre(final char toSubmit) {
        ...
        if (findLetter(toSubmit)) {
            ...
            if (this.devinage.toString().equals(this.solutionPure)) {
                /* arrêter le pendu */
                stop();
                penduMsg.append("Bravo! Vous avez trouvé le mot ").append(this.solutionPure).append('.');
            } else {
            ...
            switch (--this.vies) {
                case 0:
                    /* arrêter le pendu */
                    stop();
                    penduMsg.append("Vous avez perdu! le mot était: ").append(this.solutionPure);
                    break;
                case 1:
    ...
    public final StrBuilder submitMot(final String test) {
        ...
        if (test.equals(this.solution) || test.equals(this.solutionPure)) {
            retour.append("Bravo! Vous avez trouvé le mot ").append(this.solutionPure);
            /* arrêter le pendu */
            stop();
        } else {
            ...
            switch (--this.vies) {
                case 0:
                    stop();
                    retour.append("Vous avez perdu! le mot était: ").append(this.solutionPure);
                    break;
                /* arrêter le pendu */
                case 1:
