...
public abstract class AbstractInteractiveBoardGui implements InteractiveBoardGui {
	...
	public void addMoveAction(Square square) {
		enableSquare(square, new MoveAction(controller, square, controller.getGame().getTurn(), this));
	}
	...
	private void enableSquare(Square square, IAction action) {
